...
clock1.place(relx=0.2, rely=0.2, anchor=CENTER)
indiatime.place(relx=0.2, rely=0.37, anchor=CENTER)

USALabel = Label(root, text="USA")
clock1 = Label(root, image=clock)
USAtime = Label(root)
USALabel.place(relx=0.5, rely=0.05, anchor=CENTER)
clock1.place(relx=0.5, rely=0.2, anchor=CENTER)
USAtime.place(relx=0.5, rely=0.37, anchor=CENTER)

FranceLabel = Label(root, text="France")
clock1 = Label(root, image=clock)
Francetime = Label(root)
FranceLabel.place(relx=0.8, rely=0.05, anchor=CENTER)
clock1.place(relx=0.8, rely=0.2, anchor=CENTER)
Francetime.place(relx=0.8, rely=0.37, anchor=CENTER)
...
IndiaButton = Button(root, text="Show Time", width=10, height=2, command=India.time)
IndiaButton.place(relx=0.2, rely=0.43, anchor=CENTER)

USAButton = Button(root, text="Show Time", width=10, height=2, command=usa.time)
USAButton.place(relx=0.5, rely=0.43, anchor=CENTER)

UkButton = Button(root, text="Show Time", width=10, height=2, command=Uk.time)
UkButton.place(relx=0.2, rely=0.93, anchor=CENTER)

CanadaButton = Button(root, text="Show Time", width=10, height=2, command=Canada.time)
CanadaButton.place(relx=0.5, rely=0.93, anchor=CENTER)

FranceButton = Button(root, text="Show Time", width=10, height=2, command=France.time)
FranceButton.place(relx=0.8, rely=0.43, anchor=CENTER)
